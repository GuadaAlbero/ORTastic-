...
namespace ORTastic.Controllers
{
    public class EventosController : Controller
    {
        ...
        public EventosController(ORTasticDatabaseContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombreevento,Fecha,Equipos,Precio")] Evento evento)
        {
            if (id != evento.Id)
            {
                return NotFound();
